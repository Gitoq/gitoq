...
export const apiCliLogin = (options?: SecondParameter<typeof api>) => {
  return api<ApiCliLogin200>({ url: `/cli/login`, method: "POST" }, options);
};
...
export const apiCliLogout = (options?: SecondParameter<typeof api>) => {
  return api<ApiCliLogout200>({ url: `/cli/logout`, method: "DELETE" }, options);
};
...
export const apiCliUserWorkspaces = (options?: SecondParameter<typeof api>) => {
  return api<ApiCliUserWorkspaces200>({ url: `/cli/user-workspaces`, method: "GET" }, options);
};
...
export const apiCliWorkspaceProjects = (id: number, options?: SecondParameter<typeof api>) => {
  return api<ApiCliWorkspaceProjects200>({ url: `/cli/workspace-projects/${id}`, method: "GET" }, options);
};
